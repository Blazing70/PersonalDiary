...
#android.adaptive_icon_background = %(source.dir)s/data/icon_bg.png
...
#android.library_references = @android-support-v4,@android-support-v7-appcompat
...
# (str) Use 'python2' or 'python3' for bootstrapping the build.
# Note that if you want to use Python 3 for the build, you need to set the
# `android.gradle_dependencies` to include the Python 3 compatible version
# of the Android support library.
# python2 android.bootstrap = sdl2
# python3 android.bootstrap = sdl2
...
# For release builds, add these configurations:
[app@release]
...
# android.release_keystore = personal-diary-release-key.keystore
# android.release_keyalias = personal-diary
# android.release_keystore_passwd = YOUR_KEYSTORE_PASSWORD
# android.release_keyalias_passwd = YOUR_KEY_PASSWORD